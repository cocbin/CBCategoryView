...
Pod::Spec.new do |s|
  ...
  s.name         = "CBCategoryView"
  s.version      = "0.0.3"
  s.summary      = "A category view for ios"
  ...
  s.source       = { :git => "https://github.com/cocbin/CBCategoryView.git", :tag => "0.0.3" }
  ...
  s.source_files  = "CBCategoryView/CBCategoryView/*.{h,m}"
